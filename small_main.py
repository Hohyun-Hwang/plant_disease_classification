...
from small_dataloader import plant_image  # from dataset.py
...
def main(mode: str, total_epoch: int, graphic_device: str = 'cpu', _model: str = 'efficient', batch_size: int = 4):
    result_path = "./apple_"+ "train"  + "_epoch_" + str(total_epoch) + "_graphic_device_" + graphic_device + "_model_" + _model + "_batch_size_" + str(batch_size)
    visualization_path = "./apple_"+ "visualization"  + "_epoch_" + str(total_epoch) + "_graphic_device_" + graphic_device + "_model_" + _model + "_batch_size_" + str(batch_size)
    ...
    train_dataset_dir = "apple/train"
    test_dataset_dir = "apple/test"
